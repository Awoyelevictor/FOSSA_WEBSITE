...
import { PhoneCall as Phone } from "../components/animate-ui/icons/phone-call";
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 text-slate-600 dark:text-slate-400">
                ...
                <div className="col-span-1 md:col-span-1">
                    <div className="flex items-center gap-2 mb-4">
                        <div className="w-10 h-10 bg-indigo-900 rounded-full flex items-center justify-center text-white font-bold opacity-90">F</div>
