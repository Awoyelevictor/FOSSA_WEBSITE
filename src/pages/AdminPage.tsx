...
export const AdminPage = () => {
    ...
    const handleDeleteNote = (id: number) => {
        const updated = lectureNotes.filter((n: any) => n.id !== id);
        setLectureNotes(updated);
        saveLectureNotes(updated);
    };

    // Outline Actions
    const handleAddOutline = (e: React.FormEvent) => {
        e.preventDefault();
    ...
    const handleDeleteOutline = (id: number) => {
        const updated = outlines.filter((o: any) => o.id !== id);
        setOutlines(updated);
        saveCourseOutlines(updated);
    };
