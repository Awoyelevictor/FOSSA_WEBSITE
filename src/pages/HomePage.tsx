                ...
                <AnimateIn direction="up" delay={0.1} className="bg-white dark:bg-slate-900 rounded-[2rem] p-6 md:p-8 shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 border border-slate-100 dark:border-slate-800">
                    <AnimateStaggerContainer delay={0.05} className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        <AnimateStaggerItem className="flex flex-col items-center">
                            ...
                            <p className="text-[0.65rem] md:text-sm font-bold text-slate-550 dark:text-slate-400 uppercase tracking-widest mt-1">Departments</p>
                        </AnimateStaggerItem>
                        <AnimateStaggerItem className="flex flex-col items-center">
                            ...
                            <p className="text-[0.65rem] md:text-sm font-bold text-slate-550 dark:text-slate-400 uppercase tracking-widest mt-1">Students</p>
                        </AnimateStaggerItem>
                        <AnimateStaggerItem className="flex flex-col items-center">
                            ...
                            <p className="text-[0.65rem] md:text-sm font-bold text-slate-550 dark:text-slate-400 uppercase tracking-widest mt-1">Events Annually</p>
                        </AnimateStaggerItem>
                        <AnimateStaggerItem className="flex flex-col items-center">
                            ...
                            <p className="text-[0.65rem] md:text-sm font-bold text-slate-550 dark:text-slate-400 uppercase tracking-widest mt-1">Resources</p>
                        </AnimateStaggerItem>
                            ...
                            <AnimateStaggerContainer delay={0.06} className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                {[ {icon: Binary, name: 'Computer Science'}, {icon: FlaskConical, name: 'Physics'} ].map((dept, i) => (
                                    <AnimateStaggerItem key={i}>
                                        <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 flex flex-col items-center text-center hover:border-indigo-500/30 transition-all duration-300">
                    ...
                    <AnimateIn direction="up" delay={0.22}>
                        <section>
                            ...
                            <AnimateStaggerContainer delay={0.05} className="grid grid-cols-1 gap-3 mb-6">
                                <AnimateStaggerItem>
                                    <Link to="/dashboard" className="bg-white dark:bg-slate-900 rounded-3xl pb-6 p-4 md:p-6 shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col items-center text-center relative group hover:border-indigo-400 transition-colors block">
                                ...
                                <AnimateStaggerItem>
                                    <Link to="/dashboard" className="bg-white dark:bg-slate-900 rounded-3xl pb-6 p-4 md:p-6 shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col items-center text-center relative group hover:border-purple-400 transition-colors block">
